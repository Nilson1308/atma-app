...
from apps.users.views import DashboardDataView, PerfilClinicaView 
...
urlpatterns = [
    ...
    path('api/', include('apps.solicitacoes.urls')),
    ...
    path('api/perfil-clinica/', PerfilClinicaView.as_view(), name='perfil-clinica'),
]
